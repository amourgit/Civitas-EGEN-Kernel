 ...
 *
 * <p>Porte l'observation de deploiement et, depuis la Phase 2, de discovery
 * (voir docs/architecture/19-feuille-de-route.md). L'observation de
 * messaging rejoint cette classe en Phase 3, jamais par anticipation.</p>
 */
public record ObservedState(DeploymentObservation deployment, DiscoveryObservation discovery,
    ...
    public ObservedState {
        ...
        if (discovery == null) {
            discovery = DiscoveryObservation.empty();
        }
