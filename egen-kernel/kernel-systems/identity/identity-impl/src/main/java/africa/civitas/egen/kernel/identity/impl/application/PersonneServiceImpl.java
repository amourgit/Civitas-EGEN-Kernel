...
import africa.civitas.egen.kernel.identity.impl.infrastructure.PersonneMapper;
...
public class PersonneServiceImpl implements PersonneService {
    ...
    public Personne creer(CreerPersonneCommand commande) {
        ...
        entity.statutVerificationIdentite =
                africa.civitas.egen.kernel.identity.api.domain.StatutVerificationIdentite.NON_VERIFIEE;
