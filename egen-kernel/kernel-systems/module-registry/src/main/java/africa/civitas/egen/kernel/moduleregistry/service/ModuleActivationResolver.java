...
/**
 * Repond a la question que kernel-plugin-engine posera avant de charger un module
 * dans un Contexte donne : "ce module doit-il tourner ici ?". Fail-closed par
 ...
 * kernel-plugin-engine consulte les deux, independamment, avant de charger quoi que
 * ce soit.
 */
public interface ModuleActivationResolver {

    DecisionNoyau estActifPour(UUID contexteId, ModuleId moduleId);
}
