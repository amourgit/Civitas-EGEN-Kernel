...
import africa.civitas.egen.modules.system.identity.api.domain.StatutCompte;
...
/**
 * Entite JPA du Compte (A1.2). Jamais exposee en dehors de identity-provider-keycloak.
 */
@Entity
