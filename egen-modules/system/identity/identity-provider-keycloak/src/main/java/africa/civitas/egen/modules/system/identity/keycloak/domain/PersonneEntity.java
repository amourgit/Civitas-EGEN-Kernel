...
import africa.civitas.egen.modules.system.identity.api.domain.StatutVerificationIdentite;
...
/**
 * Entite JPA de la Personne (A1.1). Jamais exposee en dehors de identity-provider-keycloak — tout
 * consommateur externe manipule uniquement {@link africa.civitas.egen.modules.system.identity.api.domain.Personne}.
 */
@Entity
