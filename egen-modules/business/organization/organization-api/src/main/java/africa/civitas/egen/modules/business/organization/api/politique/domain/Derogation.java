...
/**
 * Modele de lecture d'une Derogation (Politique organisationnelle, §B.12) — le
 * remplacement local d'une Politique heritee par une Cellule precise. Regle de
 * resolution : la Derogation la plus proche dans l'arbre l'emporte toujours (voir
 * PolitiqueService#resoudrePourCellule).
 */
