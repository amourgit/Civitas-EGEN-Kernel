...
import africa.civitas.egen.modules.business.organization.impl.domain.FermetureTransitiveCelluleEntity;
...
public class FermetureTransitiveCelluleRepository
     ...
     *         des Derogations de la Politique organisationnelle (§B.12).
     */
